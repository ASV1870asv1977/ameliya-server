...
!function (n) {
    ...
    var e = function () {
        ...
        function c(e, t) {
            var n, i, o, s, r, a, l, c, u, d, p, h = t && t.split("/"), f = y.map, g = f && f["*"] || {};
            if (e) {
                for (r = (e = e.split("/")).length - 1, y.nodeIdCompat && w.test(e[r]) && (e[r] = e[r].replace(w, "")), "." === e[0].charAt(0) && h && (e = h.slice(0, h.length - 1).concat(e)), u = 0; u < e.length; u++) if ("." === (p = e[u])) e.splice(u, 1), u -= 1; else if (".." === p) {
            ...
            if ((h || g) && f) {
                for (u = (n = e.split("/")).length; 0 < u; u -= 1) {
                    if (i = n.slice(0, u).join("/"), h) for (d = h.length; 0 < d; d -= 1) if (o = (o = f[h.slice(0, d).join("/")]) && o[i]) {
                        s = o, a = u;
                        break
                    }
                    if (s) break;
        ...
        return e && e.requirejs || (e ? n = e : e = {}, m = {}, v = {}, y = {}, _ = {}, o = Object.prototype.hasOwnProperty, a = [].slice, w = /\.js$/, f = function (e, t) {
            ...
            var o, s, r, a, l, c, u, d = [], p = typeof n;
            if (c = S(i = i || e), "undefined" == p || "function" == p) {
                for (t = !t.length && n.length ? ["require", "exports", "module"] : t, l = 0; l < t.length; l += 1) if ("require" === (s = (a = f(t[l], c)).f)) d[l] = g.require(e); else if ("exports" === s) d[l] = g.exports(e), u = !0; else if ("module" === s) o = d[l] = g.module(e); else if (b(m, s) || b(v, s) || b(_, s)) d[l] = D(s); else {
            ...
            return t = t || function () {
            }, "function" == typeof n && (n = i, i = o), i ? s(h, e, t, n) : setTimeout(function () {
                s(h, e, t, n)
            }, 4), r
        }, r.config = function (e) {
            return r(e)
            ...
            e.prototype.on = function (e, t) {
                ...
                var n = s(t), i = t.style.overflowX, o = t.style.overflowY;
            ...
            return f.Extend(i, f.Observable), i.prototype.render = function () {
                ...
                if (e.children) {
                    var r = h(t), a = document.createElement("strong");
                ...
                this.$results.attr("id", n), t.on("results:all", function (e) {
                    ...
                    if (!(n <= 0)) {
                        ...
                        var s = l.$results.offset().top, r = o.offset().top, a = l.$results.scrollTop() + (r - s);
                    ...
                    if (!(n >= t.length)) {
                        ...
                        var o = l.$results.offset().top + l.$results.outerHeight(!1),
                            s = i.offset().top + i.outerHeight(!1), r = l.$results.scrollTop() + s - o;
                    ...
                    var t = l.$results.scrollTop(), n = l.$results.get(0).scrollHeight - t + e.deltaY,
                        i = 0 < e.deltaY && t - e.deltaY <= 0, o = e.deltaY < 0 && n <= l.$results.height();
                ...
                if (0 !== e.length) {
                    var t = this.$results.find(".select2-results__option--selectable").index(e),
                        n = this.$results.offset().top, i = e.offset().top, o = this.$results.scrollTop() + (i - n),
                        s = i - n;
                    o -= 2 * e.outerHeight(!1), t <= 2 ? this.$results.scrollTop(0) : (s > this.$results.outerHeight() || s < 0) && this.$results.scrollTop(o)
                }
            }, i.prototype.template = function (e, t) {
                var n = this.options.get("templateResult"), i = this.options.get("escapeMarkup"), o = n(e, t);
            ...
            return d.Extend(s, e), s.prototype.render = function () {
                ...
                this.$selection.find(".select2-selection__rendered").attr("id", n), this.$selection.on("click", function (e) {
                    ...
                    if (!i.isDisabled()) {
                        var t = o(this).parent(), n = d.GetData(t[0], "data");
            ...
            return e.prototype.render = function (e) {
                ...
                var i = this, o = t.id + "-results", s = t.id + "-container";
            ...
            function e(e, t, n) {
                ...
                if (void 0 !== s && (this.insertTag = s), e.call(this, t, n), Array.isArray(i)) for (var r = 0; r < i.length; r++) {
                    var a = i[r], l = this._normalizeItem(a), c = this.option(l);
            ...
            return e.prototype.query = function (e, c, u) {
                ...
                this._removeOldTags(), null != c.term && null == c.page ? e.call(this, c, function e(t, n) {
                    for (var i = t.results, o = 0; o < i.length; o++) {
                        var s = i[o], r = null != s.children && !e({results: s.children}, !0);
            ...
            return e.prototype.bind = function (e, t, n) {
                ...
                for (var o = n.get("tokenSeparators") || [], s = t.term, r = 0, a = this.createTag || function (e) {
                    ...
                    var l = s[r];
                    if (-1 !== o.indexOf(l)) {
                        var c = s.substr(0, r), u = a(d.extend({}, t, {term: c}));
            ...
            return e.prototype.bind = function (e, t, n) {
                ...
                var n = this, i = "scroll.select2." + t.id, o = "resize.select2." + t.id,
                    s = "orientationchange.select2." + t.id, r = this.$container.parents().filter(a.hasScroll);
                r.each(function () {
                ...
                var n = "scroll.select2." + t.id, i = "resize.select2." + t.id, o = "orientationchange.select2." + t.id;
                ...
                var r = this.$dropdown.outerHeight(!1), a = e.scrollTop(), l = e.scrollTop() + e.height(),
                    c = a < o.top - r, u = l > o.bottom + r, d = {left: o.left, top: s.bottom},
            ...
            return n.prototype.apply = function (e) {
                ...
                this.defaults = {
                    ...
                    matcher: function e(t, n) {
                        ...
                        var s = a(n.text).toUpperCase(), r = a(t.term).toUpperCase();
                ...
                var n = e.language, i = this.defaults.language, o = t.prop("lang"),
            ...
            return e.prototype.fromElement = function (e) {
                ...
                for (var o = 0; o < e[0].attributes.length; o++) {
                    var s = e[0].attributes[o].name, r = "data-";
                    if (s.substr(0, r.length) == r) {
                        var a = s.substring(r.length), l = p.GetData(e[0], a);
            ...
            function i(e) {
                var t, n = e || window.event, i = g.call(arguments, 1), o = 0, s = 0, r = 0, a = 0, l = 0;
